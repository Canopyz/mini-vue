...
function isTracking() {
    return exports.activeEffect !== null && exports.shouldTrack;
}
class ReactiveEffect {
    ...
    run() {
        ...
        let parent = exports.activeEffect;
        exports.activeEffect = this;
        const lastShouldTrack = exports.shouldTrack;
        exports.shouldTrack = true;
        const res = this.fn();
        exports.shouldTrack = lastShouldTrack;
        exports.activeEffect = parent;
        return res;
    }
    stop() {
        if (this.active) {
...
function trackEffects(deps) {
    exports.activeEffect = exports.activeEffect;
...
function createGetter(isReadonly = false, isShallow = false) {
    return function get(target, key) {
        if (key === exports.ReactiveFlags.REACTIVE) {
            return !isReadonly;
        }
        else if (key === exports.ReactiveFlags.READONLY) {
            return isReadonly;
        }
        if (!isReadonly) {
            track(target, key);
...
function isReactive(value) {
    return !!value[exports.ReactiveFlags.REACTIVE];
}
function isReadonly(value) {
    return !!value[exports.ReactiveFlags.READONLY];
}
...
var runtimeDom = /*#__PURE__*/Object.freeze({
    ...
    RefImpl: RefImpl,
    get activeEffect () { return exports.activeEffect; },
    computed: computed,
    createApp: createApp,
    ...
    get shouldTrack () { return exports.shouldTrack; },
    stop: stop,
    toDisplayString: toDisplayString,
    toReactive: toReactive,
    track: track,
    trackEffects: trackEffects,
    trackRefEffects: trackRefEffects,
    trigger: trigger,
    triggerEffects: triggerEffects,
    triggerRefEffects: triggerRefEffects,
    unRef: unRef
});
...
exports.trackRefEffects = trackRefEffects;
exports.trigger = trigger;
exports.triggerEffects = triggerEffects;
exports.triggerRefEffects = triggerRefEffects;
exports.unRef = unRef;
